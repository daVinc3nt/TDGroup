...
exports.saveImgDescription = exports.deleteFile = exports.deleteProject = exports.getFile = exports.savePost = exports.uploadFileBelongToProject = exports.getProjects = exports.createProject = exports.logout = exports.login = exports.getSession = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("http://localhost:3000/get_session", {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.get("http://localhost:3000/v1/media/logout", {
                            withCredentials: true,
                        })];
                case 1:
                    response = _c.sent();
                ...
                case 2:
                    error_3 = _c.sent();
                    console.error('Error uploading post:', (_a = error_3 === null || error_3 === void 0 ? void 0 : error_3.response) === null || _a === void 0 ? void 0 : _a.data);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    error_5 = _c.sent();
                    console.error('Error getting posts:', (_a = error_5 === null || error_5 === void 0 ? void 0 : error_5.response) === null || _a === void 0 ? void 0 : _a.data);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post("http://localhost:3000/v1/media/project/file?id=".concat(postPayload.project_id), formData, {
                            withCredentials: true,
                        })];
                case 1:
                    response = _c.sent();
                ...
                case 2:
                    error_6 = _c.sent();
                    console.error('Error uploading post:', (_a = error_6 === null || error_6 === void 0 ? void 0 : error_6.response) === null || _a === void 0 ? void 0 : _a.data);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    error_7 = _c.sent();
                    console.error('Error uploading post:', (_a = error_7 === null || error_7 === void 0 ? void 0 : error_7.response) === null || _a === void 0 ? void 0 : _a.data);
...
function getFile(criteria) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var response, blob, imgUrl, error_8;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                ...
                case 2:
                    error_8 = _c.sent();
                    console.error('Error getting file:', (_a = error_8 === null || error_8 === void 0 ? void 0 : error_8.response) === null || _a === void 0 ? void 0 : _a.data);
                    console.error("Request that caused the error: ", error_8 === null || error_8 === void 0 ? void 0 : error_8.request);
                    return [2 /*return*/, { error: (_b = error_8 === null || error_8 === void 0 ? void 0 : error_8.response) === null || _b === void 0 ? void 0 : _b.data, request: error_8 === null || error_8 === void 0 ? void 0 : error_8.request, status: error_8.response ? error_8.response.status : null }]; // Ném lỗi để xử lý bên ngoài
                case 3: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.delete("http://localhost:3000/v1/media/project?id=".concat(condition.project_id), {
                            withCredentials: true
                        })];
                case 1:
                    response = _c.sent();
                ...
                case 2:
                    error_9 = _c.sent();
                    console.error('Error getting posts:', (_a = error_9 === null || error_9 === void 0 ? void 0 : error_9.response) === null || _a === void 0 ? void 0 : _a.data);
                    console.error("Request that caused the error: ", error_9 === null || error_9 === void 0 ? void 0 : error_9.request);
                    return [2 /*return*/, { error: (_b = error_9 === null || error_9 === void 0 ? void 0 : error_9.response) === null || _b === void 0 ? void 0 : _b.data, request: error_9 === null || error_9 === void 0 ? void 0 : error_9.request, status: error_9.response ? error_9.response.status : null }]; // Ném lỗi để xử lý bên ngoài
                case 3: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1.default.delete("http://localhost:3000/v1/media/project/file?project_id=".concat(criteria.project_id, "&file=").concat(criteria.file), {
                            withCredentials: true,
                        })];
                case 1:
                    response = _c.sent();
                ...
                case 2:
                    error_10 = _c.sent();
                    console.error('Error getting file:', (_a = error_10 === null || error_10 === void 0 ? void 0 : error_10.response) === null || _a === void 0 ? void 0 : _a.data);
                    console.error("Request that caused the error: ", error_10 === null || error_10 === void 0 ? void 0 : error_10.request);
                    return [2 /*return*/, { error: (_b = error_10 === null || error_10 === void 0 ? void 0 : error_10.response) === null || _b === void 0 ? void 0 : _b.data, request: error_10 === null || error_10 === void 0 ? void 0 : error_10.request, status: error_10.response ? error_10.response.status : null }]; // Ném lỗi để xử lý bên ngoài
                case 3: return [2 /*return*/];
            }
        });
    });
...
//lưu hình ảnh mô tả
function saveImgDescription(postPayload) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    formData = new FormData();
                    formData.append('file', postPayload.file);
                    return [4 /*yield*/, axios_1.default.post("http://localhost:3000/v1/media/project/post_default?id=".concat(postPayload.project_id), formData, {
                            withCredentials: true,
                        })];
                case 1:
                    response = _c.sent();
                ...
                case 2:
                    error_11 = _c.sent();
                    console.error('Error uploading post:', (_a = error_11 === null || error_11 === void 0 ? void 0 : error_11.response) === null || _a === void 0 ? void 0 : _a.data);
                    console.error("Request that caused the error: ", error_11 === null || error_11 === void 0 ? void 0 : error_11.request);
                    return [2 /*return*/, { error: (_b = error_11 === null || error_11 === void 0 ? void 0 : error_11.response) === null || _b === void 0 ? void 0 : _b.data, request: error_11 === null || error_11 === void 0 ? void 0 : error_11.request, status: error_11.response ? error_11.response.status : null }]; // Ném lỗi để xử lý bên ngoài
                case 3: return [2 /*return*/];
            }
        });
    });
}
exports.saveImgDescription = saveImgDescription;
